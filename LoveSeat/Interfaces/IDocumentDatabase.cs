...
namespace LoveSeat.Interfaces
{
	public interface IDocumentDatabase
	{
		...
		///// <returns></returns>
		//Result<JsonDocument> CreateDocument(string jsonForDocument, Result<JsonDocument> result);
		///// <summary>
		...
		///// <returns></returns>
		//Result<JsonDocument> CreateDocument(string id, string jsonForDocument, Result<JsonDocument> result);
		///// <summary>
		///// Creates a document using the JsonDocument provided. 
		///// No validation or smarts attempted here by design for simplicities sake
		///// </summary>
		///// <param name="id">Id of Document</param>
		///// <param name="jsonForDocument"></param>
		///// <returns></returns>
		//Result<JsonDocument> CreateDocument(JsonDocument doc, Result<JsonDocument> result);
		...
		///// <param name="id"></param>
		///// <returns></returns>
		//Result<JsonDocument> GetDocument(string id, Result<JsonDocument> result);
		...
		//Result<Stream> GetAttachmentStream(JsonDocument doc, string attachmentName,Result<Stream> result);
		...
		//Result<ICouchDocument> SaveDocument(ICouchDocument document, Result<ICouchDocument> result);
